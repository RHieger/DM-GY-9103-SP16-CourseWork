...
class ItemsViewController: UITableViewController {
    ...
    // FULL DISCLOSURE: The alterations made to the ItemsViewController
    //                  class are based on an online tutorial to which
    //                  I am greatly indebted. The URL of this tutorial
    //                  is:
    //
